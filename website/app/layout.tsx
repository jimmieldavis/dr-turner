...
export const metadata: Metadata = {
  ...
  description:
    'Dr. Shairi Turner is a physician, public health leader, and Chief Health Officer at Crisis Text Line. Stanford, Case Western, Mass General, Harvard. 221 media engagements. Booking and media inquiries welcome.',
  keywords: [
    'Shairi Turner',
    'Dr. Shairi Turner',
    'mental health',
